...
func NewMutexByteStore(bg ByteGetter, bp BytePutter, d Deleter, m Marshaler, un Unmarshaler, idf IdFactory, vf VersionFactory, ei EntityInitialiser, inee IsNonExtantError) Store {
	mtx := sync.Mutex{}
