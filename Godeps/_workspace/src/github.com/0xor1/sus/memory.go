...
func NewJsonMemoryStore(idf IdFactory, vf VersionFactory, ei EntityInitialiser) Store {
...
func NewMemoryStore(m Marshaler, un Unmarshaler, idf IdFactory, vf VersionFactory, ei EntityInitialiser) Store {
